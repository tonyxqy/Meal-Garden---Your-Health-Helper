<template>
	<view class="components-home">
		...
		<block>
			<!-- index.wxml -->
			<view class="page">
				<view class="canvas" :style="'height:' + winHeight + 'rpx'">
					<!-- 云朵位移 -->
					<view class="cloud">
					...
					<view class="tree" :style="'height:' + winHeight+ 'rpx'">
						...
						<image :src="'/static/image/tree-' + stages + '.png'"
							:class="'tree-' + stages + ' ' + (treemove ? 'move-' + stages : '')" hover-class="none"
							@tap="tree"></image>
					</view>
					...
					<view class="sumup">
						...
						<view class="speed">
							<view class="progress">
								<image class="speed-1"
									:src="'/static/image/speed-1' + (1 == stages ? '-h' : '') + '.png'"></image>
								<image class="speed-2"
									:src="'/static/image/speed-2' + (2 == stages ? '-h' : '') + '.png'"></image>
								<image class="speed-3"
									:src="'/static/image/speed-3' + (3 == stages ? '-h' : '') + '.png'"></image>
							</view>
						</view>
					</view>
				</view>
...
<style>
	...
	.canvas .tree .rain {
		...
		box-shadow: 0 0 16rpx 6rpx #b8ffc4;
		border-radius: 50%;
