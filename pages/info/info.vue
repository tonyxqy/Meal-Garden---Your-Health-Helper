				...
				<view class="jq22-mine-list">
					<navigator url="/pages/setinfo/setinfo" class="jq22-flex">
						<view class="jq22-cou-img">
							<image src="/static/pages/info/images/icon-item-000.png" alt=""></image>
						</view>
						<view class="jq22-flex-box">
					...
					<navigator url="/pages/setinfo/setinfo?currentTab=0" class="jq22-flex b-line">
						<view class="jq22-cou-img">
							<image src="/static/pages/info/images/icon-item-003.png" alt=""></image>
						</view>
						<view class="jq22-flex-box">
					...
					<navigator url="/pages/setinfo/setinfo?currentTab=1" class="jq22-flex b-line">
						<view class="jq22-cou-img">
							<image src="/static/pages/info/images/icon-item-004.png" alt=""></image>
						</view>
						<view class="jq22-flex-box">
					...
					<navigator url="/pages/setinfo/setinfo?currentTab=2" class="jq22-flex b-line">
						<view class="jq22-cou-img">
							<image src="/static/pages/info/images/icon-item-005.png" alt=""></image>
						</view>
						<view class="jq22-flex-box">
					...
					<navigator url="/pages/setinfo/setinfo?currentTab=3" class="jq22-flex b-line">
						<view class="jq22-cou-img">
							<image src="/static/pages/info/images/icon-item-006.png" alt=""></image>
						</view>
						<view class="jq22-flex-box">
					...
					<navigator url="/pages/setinfo/setinfo?currentTab=4" class="jq22-flex b-line">
						<view class="jq22-cou-img">
							<image src="/static/pages/info/images/icon-item-007.png" alt=""></image>
						</view>
						<view class="jq22-flex-box">
					...
					<navigator url="/pages/setinfo/setinfo?currentTab=5" class="jq22-flex b-line">
						<view class="jq22-cou-img">
							<image src="/static/pages/info/images/icon-item-009.png" alt=""></image>
						</view>
						<view class="jq22-flex-box">
					...
					<navigator url="/pages/setinfo/setinfo?currentTab=6" class="jq22-flex b-line">
						<view class="jq22-cou-img">
							<image src="/static/pages/info/images/icon-item-010.png" alt=""></image>
						</view>
						<view class="jq22-flex-box">
